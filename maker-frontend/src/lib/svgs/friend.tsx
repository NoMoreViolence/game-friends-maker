...
const FriendSvg: React.SFC<Props> = props => (
  <>
    <svg
    ...
    >
      ...
      <path
        ...
        opacity="0.1"
      />
      <circle cx="939.95" cy="375.52" r="102.23" fill="#5f5fc4" />
      <circle cx="831.23" cy="347.59" r="102.23" fill="#5f5fc4" />
      <circle cx="711.55" cy="348.59" r="102.23" fill="#5f5fc4" />
      <circle cx="672.65" cy="375.52" r="102.23" fill="#5f5fc4" />
      <circle cx="606.82" cy="384.5" r="102.23" fill="#5f5fc4" />
      <circle cx="579.89" cy="303.71" r="102.23" fill="#5f5fc4" />
      <circle cx="609.81" cy="209.95" r="102.23" fill="#5f5fc4" />
      <circle cx="666.66" cy="209.95" r="102.23" fill="#5f5fc4" />
      <circle cx="699.58" cy="168.06" r="102.23" fill="#5f5fc4" />
      <circle cx="783.36" cy="213.94" r="102.23" fill="#5f5fc4" />
      <circle cx="978.85" cy="303.71" r="102.23" fill="#5f5fc4" />
      <circle cx="920" cy="252.84" r="102.23" fill="#5f5fc4" />
      <circle cx="882.1" cy="201.97" r="102.23" fill="#5f5fc4" />
      <circle cx="810.29" cy="125.17" r="102.23" fill="#5f5fc4" />
      <circle cx="943.94" cy="209.95" r="102.23" fill="#5f5fc4" />
      <g opacity="0.1">
      ...
      <path d="M918.34,614.12s62.5-52.53,31.58-127.33L919,475.21,885.45,578.5Z" transform="translate(-28.88 -59.45)" fill="#67647e" />
      <path
        d="M921.67,471.65l7.4,2.77L896.13,575.83l28.74,31.12c-2.38,2.37-3.86,3.61-3.86,3.61l-32.9-35.62Z"
        transform="translate(-28.88 -59.45)"
        opacity="0.1"
      />
      <ellipse cx="579.5" cy="687.94" rx="556.5" ry="93.16" fill="#5f5fc4" opacity="0.1" />
      <path
      ...
      <path
        ...
        fill="#5f5fc4"
      />
      <path d="M145.23,668.5s7.81,37.56-13.56,61" transform="translate(-28.88 -59.45)" fill="none" stroke="#535461" strokeMiterlimit="10" />
      <path
      ...
      <path
        ...
        opacity="0.2"
      />
      <circle cx="939.95" cy="352.58" r="102.23" fill="#5f5fc4" />
      <circle cx="831.23" cy="324.65" r="102.23" fill="#5f5fc4" />
      <circle cx="711.55" cy="325.65" r="102.23" fill="#5f5fc4" />
      <circle cx="672.65" cy="352.58" r="102.23" fill="#5f5fc4" />
      <circle cx="606.82" cy="361.56" r="102.23" fill="#5f5fc4" />
      <circle cx="579.89" cy="280.77" r="102.23" fill="#5f5fc4" />
      <circle cx="609.81" cy="187.01" r="102.23" fill="#5f5fc4" />
      <circle cx="666.66" cy="187.01" r="102.23" fill="#5f5fc4" />
      <circle cx="699.58" cy="145.12" r="102.23" fill="#5f5fc4" />
      <circle cx="783.36" cy="191" r="102.23" fill="#5f5fc4" />
      <circle cx="978.85" cy="280.77" r="102.23" fill="#5f5fc4" />
      <circle cx="920" cy="229.9" r="102.23" fill="#5f5fc4" />
      <circle cx="882.1" cy="179.03" r="102.23" fill="#5f5fc4" />
      <circle cx="810.29" cy="102.23" r="102.23" fill="#5f5fc4" />
      <circle cx="943.94" cy="187.01" r="102.23" fill="#5f5fc4" />
      ...
      />
      <g opacity="0.05">
        <path d="M858.09,642.86l-1.71-.57-7.88-9.09a2.22,2.22,0,0,0,.05-1.34Z" transform="translate(-28.88 -59.45)" />
        <path
      ...
      <path
        ...
        fill="#cedad5"
      />
      <path d="M778.36,755.27A42.39,42.39,0,0,0,766.88,749a41,41,0,0,1-11-5.74" transform="translate(-28.88 -59.45)" opacity="0.1" />
      <path
      ...
      />
      <rect x="490.14" y="724.24" width="59.84" height="42.86" transform="translate(1011.23 1431.89) rotate(-180)" fill="#5f5d7e" />
      <path
      ...
      <path
        ...
        opacity="0.1"
      />
      <path d="M512.21,687.32l29.28,29.28s-10.19,8.91-8.06,18.25l-21.22-23.77Z" transform="translate(-28.88 -59.45)" fill="#c4c8e2" />
      <path
