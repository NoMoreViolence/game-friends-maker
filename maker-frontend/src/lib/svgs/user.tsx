...
const UserSvg: React.SFC<Props> = props => (
  <>
    <svg
    ...
    >
      <defs>
        ...
        />
        <linearGradient id="ada07a9a-e50a-4215-9506-0eaaef22308f" x1="588.52" y1="693.03" x2="588.52" y2="483.16" />
      </defs>
      <title>about me</title>
      <ellipse cx="560.76" cy="725.03" rx="541" ry="31" fill="#6c63ff" opacity="0.1" />
      <g opacity="0.2">
        <path
          ...
          fill="#3f3d56"
        />
        <ellipse cx="1022.06" cy="778.26" rx="14.01" ry="10.7" transform="translate(-160.29 1245.24) rotate(-62.09)" fill="#3f3d56" />
        <ellipse cx="1030.07" cy="763.12" rx="14.01" ry="10.7" transform="translate(-142.65 1244.27) rotate(-62.09)" fill="#3f3d56" />
        <ellipse cx="1038.09" cy="747.99" rx="14.01" ry="10.7" transform="translate(-125.01 1243.3) rotate(-62.09)" fill="#3f3d56" />
        <ellipse cx="1046.11" cy="732.85" rx="14.01" ry="10.7" transform="translate(-107.37 1242.33) rotate(-62.09)" fill="#3f3d56" />
        <path
      ...
      <g opacity="0.2">
        <path
          ...
          fill="#3f3d56"
        />
        <ellipse cx="985.03" cy="463.85" rx="22.69" ry="17.33" transform="translate(184.88 1147.47) rotate(-69.16)" fill="#3f3d56" />
        <ellipse cx="994.89" cy="437.94" rx="22.69" ry="17.33" transform="translate(215.46 1139.99) rotate(-69.16)" fill="#3f3d56" />
        <ellipse cx="1004.76" cy="412.02" rx="22.69" ry="17.33" transform="translate(246.03 1132.51) rotate(-69.16)" fill="#3f3d56" />
        <ellipse cx="1014.62" cy="386.11" rx="22.69" ry="17.33" transform="translate(276.61 1125.04) rotate(-69.16)" fill="#3f3d56" />
        <path
      ...
      <g opacity="0.2">
        <path
          ...
          fill="#3f3d56"
        />
        <ellipse cx="206.83" cy="545.22" rx="20.61" ry="26.98" transform="translate(-139.61 -7.4) rotate(-13.72)" fill="#3f3d56" />
        <ellipse cx="199.01" cy="513.19" rx="20.61" ry="26.98" transform="translate(-132.24 -10.16) rotate(-13.72)" fill="#3f3d56" />
        <ellipse cx="191.2" cy="481.16" rx="20.61" ry="26.98" transform="translate(-124.87 -12.93) rotate(-13.72)" fill="#3f3d56" />
        <ellipse cx="183.38" cy="449.12" rx="20.61" ry="26.98" transform="translate(-117.5 -15.7) rotate(-13.72)" fill="#3f3d56" />
        <path
